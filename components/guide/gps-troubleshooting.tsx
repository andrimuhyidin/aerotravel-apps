...
export function GPSTroubleshooting() {
  ...
  const runDiagnostics = async () => {
    ...
    try {
      ...
      // Test GPS
      const _position = await getCurrentPosition();
  ...
  return (
    <Card className="border-0 border-slate-200 shadow-sm">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between rounded-lg bg-slate-50 p-3">
            ...
            {permissionInfo.icon === 'check' && (
              <CheckCircle className="h-5 w-5 text-emerald-600" />
            )}
            {permissionInfo.icon === 'x' && (
              <X className="h-5 w-5 text-red-600" />
            )}
            {permissionInfo.icon === 'alert' && (
        ...
        <Button
          ...
          disabled={
            diagnostics.testRunning || !diagnostics.geolocationSupported
          }
        >
        ...
        <div className="space-y-2">
          ...
          <ol className="space-y-2 text-sm text-slate-700">
            <li className="flex gap-2">
              ...
              <span>
                Pastikan GPS perangkat sudah aktif di pengaturan sistem
              </span>
            </li>
            <li className="flex gap-2">
              <span className="flex-shrink-0 font-semibold text-slate-600">
              ...
              <span>
                Berikan izin lokasi ke browser (pilih &quot;Izinkan semua
                waktu&quot; untuk PWA)
              </span>
            </li>
            <li className="flex gap-2">
              ...
              <span>
                Pindah ke area terbuka (tidak di dalam gedung) untuk akurasi GPS
                lebih baik
              </span>
            </li>
            <li className="flex gap-2">
              ...
              <span>
                Pastikan koneksi internet stabil (untuk akurasi tinggi)
              </span>
            </li>
            <li className="flex gap-2">
              <span className="flex-shrink-0 font-semibold text-slate-600">
