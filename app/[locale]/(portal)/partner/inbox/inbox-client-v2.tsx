/**
 * Partner Inbox Client Component - IMPROVED
 * Clean, mobile-first design dengan better visual hierarchy
 */
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <div className="flex gap-2">
              ...
              <Sheet open={showFilterSheet} onOpenChange={setShowFilterSheet}>
                ...
                <SheetContent side="right" className="w-[300px]">
                  <SheetHeader>
                    ...
                    <SheetDescription>Filter pesan berdasarkan kategori & prioritas</SheetDescription>
                  </SheetHeader>
              ...
              <Sheet open={showNewMessageSheet} onOpenChange={setShowNewMessageSheet}>
                ...
                <SheetContent side="right">
                  <SheetHeader>
                    <SheetTitle>Pesan Baru</SheetTitle>
                    <SheetDescription>Kirim pesan ke tim Aero</SheetDescription>
                  </SheetHeader>
                  <div className="space-y-4 mt-6">
                    <div>
      ...
      <Sheet open={showReplySheet} onOpenChange={setShowReplySheet}>
        <SheetContent side="right">
          <SheetHeader>
            <SheetTitle>Balas Pesan</SheetTitle>
            <SheetDescription>
              Balas pesan dari {replyingTo?.senderName || 'Admin'}
            </SheetDescription>
          </SheetHeader>
          <div className="space-y-4 mt-6">
            <div>
