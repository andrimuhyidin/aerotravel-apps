...
export function WeatherClient({ locale: _locale }: WeatherClientProps) {
  ...
  const {
    ...
    queryFn: async () => {
      ...
      const res = await fetch(
        `/api/guide/weather?lat=${location.lat}&lng=${location.lng}`
      );
  ...
  const { data: aiInsightsData, isLoading: aiInsightsLoading } = useQuery<{
    ...
    queryFn: async () => {
      if (!location) return null;
      const res = await fetch(
        `/api/guide/weather/insights?lat=${location.lat}&lng=${location.lng}`
      );
    ...
    <div className="space-y-4 pb-6">
        ...
        <div className={cn('bg-gradient-to-br p-6 text-white', gradientClass)}>
          ...
          <div className="mt-6 grid grid-cols-3 gap-4 rounded-xl bg-white/20 p-4 backdrop-blur-sm">
            <div className="text-center">
              <Wind className="mx-auto mb-1 h-5 w-5" />
              <div className="text-xs text-white/80">Angin</div>
              <div className="mt-0.5 text-sm font-semibold">
                {weatherData.current?.wind_speed || 0} km/h
              </div>
            </div>
            <div className="text-center">
            ...
            {weatherData.current?.pressure && (
              <div className="text-center">
                <Gauge className="mx-auto mb-1 h-5 w-5" />
      ...
      {aiInsightsData?.insights?.trip_specific_insights &&
        aiInsightsData.insights.trip_specific_insights.length > 0 && (
          <TripInsights
            insights={aiInsightsData.insights.trip_specific_insights}
          />
        )}
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-xl border border-purple-200 bg-white p-4">
                <div className="mb-1 text-xs text-purple-700">
                  Dampak Rating
                </div>
                <div className="text-2xl font-bold text-purple-900">
                  {typeof aiInsightsData.insights.performance_impact
                    .predictedRatingImpact === 'number'
              ...
              <div className="rounded-xl border border-purple-200 bg-white p-4">
                ...
                <div className="text-2xl font-bold capitalize text-purple-900">
                  {aiInsightsData.insights.performance_impact.onTimeRisk ===
                  'low'
                    ? 'Rendah'
                    : aiInsightsData.insights.performance_impact.onTimeRisk ===
                        'medium'
              ...
              <div className="rounded-xl border border-purple-200 bg-white p-4">
                ...
                <div className="mt-1 text-xs text-purple-600">Probabilitas</div>
              </div>
              <div className="rounded-xl border border-purple-200 bg-white p-4">
                <div className="mb-1 text-xs text-purple-700">
                  Risiko Pendapatan
      ...
      {aiInsightsData?.insights && (
        <Card className="border-0 bg-gradient-to-br from-emerald-50 to-blue-50 shadow-sm">
          ...
          <CardContent className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <Shield
                    className={cn(
                      ...
                      aiInsightsData.insights.safety_assessment.level ===
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {Array.isArray(
                      aiInsightsData.insights.safety_assessment.warnings
                    ) &&
                      aiInsightsData.insights.safety_assessment.warnings
                        .length > 0 && (
                        <div className="mt-3 space-y-1">
                          {aiInsightsData.insights.safety_assessment.warnings.map(
                            (warning, i) => (
                              <div
                                key={i}
            ...
            {Array.isArray(aiInsightsData.insights.trip_recommendations) &&
              aiInsightsData.insights.trip_recommendations.length > 0 && (
                <div className="rounded-xl border border-blue-200 bg-white p-4">
                  ...
                  <div className="space-y-2">
                    {aiInsightsData.insights.trip_recommendations.map(
                      (rec, i) => (
              ...
              <div className="rounded-xl border border-cyan-200 bg-white p-4">
                ...
                <div className="mb-3 grid grid-cols-2 gap-3">
                  <div className="rounded-lg bg-cyan-50 p-3">
                    <div className="mb-1 text-xs text-cyan-700">
                      Tinggi Gelombang
                    </div>
                    <div className="font-semibold capitalize text-slate-900">
                      {aiInsightsData.insights.sea_conditions.wave_height ===
                      'calm'
                        ? 'Tenang'
                        : aiInsightsData.insights.sea_conditions.wave_height ===
                            'moderate'
                  ...
                  <div className="rounded-lg bg-cyan-50 p-3">
                    ...
                    <div className="font-semibold capitalize text-slate-900">
                      {aiInsightsData.insights.sea_conditions.visibility ===
                      'excellent'
                        ? 'Sangat Baik'
                        : aiInsightsData.insights.sea_conditions.visibility ===
                            'good'
            ...
            {Array.isArray(aiInsightsData.insights.equipment_suggestions) &&
              aiInsightsData.insights.equipment_suggestions.length > 0 && (
                <div className="rounded-xl border border-purple-200 bg-white p-4">
                  <div className="mb-3 flex items-center gap-2">
                  ...
                  <div className="space-y-2">
                    {aiInsightsData.insights.equipment_suggestions.map(
                      (item, i) => (
            ...
            {aiInsightsData.insights.best_times && (
              <div className="rounded-xl border border-emerald-200 bg-white p-4">
                ...
                <div className="space-y-2">
                  <div>
                    <div className="mb-1 text-xs text-slate-600">Hari Ini</div>
                    <p className="text-sm text-slate-900">
                      {aiInsightsData.insights.best_times.today}
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-slate-900">
                      {aiInsightsData.insights.best_times.next_3_days}
                    </p>
                  </div>
                </div>
              </div>
            ...
            {Array.isArray(aiInsightsData.insights.clothing_recommendations) &&
              aiInsightsData.insights.clothing_recommendations.length > 0 && (
                <div className="rounded-xl border border-slate-200 bg-white p-4">
                  ...
                  <ul className="space-y-1.5">
                    {aiInsightsData.insights.clothing_recommendations.map(
                      (rec, i) => (
                        <li
                          key={i}
      ...
      {weatherData?.alerts &&
        Array.isArray(weatherData.alerts) &&
      ...
      {/* Moon Phases */}
      {location && <MoonPhases lat={location.lat} lng={location.lng} />}
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            {weatherData.current?.uv_index !== undefined &&
              weatherData.current.uv_index !== null && (
                <>
                  <div className="rounded-xl bg-slate-50 p-4">
                    <div className="mb-2 flex items-center gap-2 text-slate-600">
